...
import {Container,Button,TextField,KeyboardAvoidingView,Text,IconButton,Divider,} from 'components';
...
const Auth = ({ navigation }) => {
  ...
  return (
    <Container asGradient>
      <KeyboardAvoidingView keyboardWillShow contentContainerStyle={styles.container}>
