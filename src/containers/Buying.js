...
import Offer from '../containers/TabViews/Buying/Offer';
import Confirmed from '../containers/TabViews/Buying/Confirmed';1
import History from '../containers/TabViews/Buying/History';
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={{marginLeft:scale(15),flexDirection:'row',height:60,alignItems:'center',borderBottomLeftRadius:50}}>
         <SimpleLineIcons name="arrow-left-circle" size={22} color='#fff' onPress={() => navigation.goBack()}/>
          <View>
            <Text style={styles.txt}>BUYING</Text>
          </View>
       </View>
        </LinearGradient>
